...
jQuery(document).ready(function(a){"use strict";function b(b){var c=!1,d=[];return b.each(function(b,c){a(c).find("input").val()||d.push(c)}),c=!d.length}if(a("body.single-product").length){var c=a(".variations_form"),d=a('.quantity input[type="number"]'),e=a('.addon-options-wrap .form-row[class*="-name"]');d.on("change, keyup",function(){var b=a(this),c=b.val();e.removeClass("required").hide();for(var d=0;d<c;d++)e.eq(d).show().addClass("required")}),c.on("submit",function(c){var d=b(a(".addon-options-wrap .form-row.required"));return!!d||(alert("Enter a full name for each ticket"),!1)})}jQuery("ul.sf-menu").supersubs({minWidth:2,maxWidth:20,extraWidth:0}).superfish({animation:{opacity:"show"},animationOut:{opacity:"hide"},speed:200,speedOut:"normal",autoArrows:!0,dropShadows:!1,delay:400}),a(".gallery-progression").flexslider({animation:"fade",slideDirection:"horizontal",slideshow:!1,slideshowSpeed:7e3,animationDuration:200,directionNav:!0,controlNav:!0}),a(".width-container").fitVids(),a("#fixed-nav-pro nav").scrollToFixed(),a("#schedule-content-progression").hide(0).delay(250).fadeIn(250),a("#filterOptions-pro li a").click(function(){var b=a(this).attr("class");return a("#filterOptions-pro li").removeClass("current-cat"),a(this).parent().addClass("current-cat"),a("#schedule-content-progression").children("li:not(."+b+")").fadeOut(250),a("#schedule-content-progression").children("li."+b).delay(250).fadeIn(250),!1});var f=audiojs.createAll({trackEnded:function(){var b=a("ol li.playing").next();b.length||(b=a("ol li").first()),b.addClass("playing").siblings().removeClass("playing"),g.load(a("a",b).attr("data-src")),g.play()}}),g=f[0],h=a("ol a").data("src");if(a("ol li").first().addClass("playing"),"undefined"==typeof g);else{g.load(h);var i=a("ol a").first().text(),j=a("ol a").first().data("buy-link"),k=a("ol a").first().data("poster");a(".buy-song").attr("href",j),a(".poster").attr("src",k),a(".audiojs h2").text(i),a("ol li").click(function(b){if(b.preventDefault(),!a(this).is(".coming-soon")){var c=a(this).find("a").data("song-id"),d=a(this).text();a("#"+c).addClass("active").siblings().removeClass("active"),a(this).addClass("playing").siblings().removeClass("playing"),g.load(a("a",this).attr("data-src")),a(".audiojs h2").text(d),g.play()}}),a(document).keydown(function(b){var c=b.charCode?b.charCode:b.keyCode;if(39==c){var d=a("li.playing").next();d.length||(d=a("ol li").first()),d.click()}else if(37==c){var e=a("li.playing").prev();e.length||(e=a("ol li").last()),e.click()}else 32==c&&g.playPause()}),a(".info ul li").click(function(){if(!a(this).is(".active")){a(this).toggleClass("active").siblings().toggleClass("active");var b=a(this).data("info-toggle");"lyrics"===b?(a(".song-extras .active .lyrics").addClass("selected"),a(".song-extras .active .about").removeClass("selected")):(a(".song-extras .active .about").addClass("selected"),a(".song-extras .active .lyrics").removeClass("selected"))}})}a(".readmore").click(function(){a(this).slideUp(),a(".hide").slideDown()}),a(".sf-menu").mobileMenu({defaultText:'"Navigate to...", "progression"',className:"select-menu",subMenuDash:"&ndash;&ndash;"}),a("#friday-sallfest-kickoff-free-show").on("click",function(a){a.preventDefault()})});