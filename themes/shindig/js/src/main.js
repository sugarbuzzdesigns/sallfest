...
jQuery(document).ready(function($) {
  ...
  //       $('.addon-options-wrap .form-row.required')
  //     )
  ...
  //     if (
  //       Number($('.quantity input[type="number"]').val()) > 1 &&
  //       $('.product-addon textarea').val().length === 0
  //     ) {
...
*/
  ...
  if (typeof audio === 'undefined') {
    ...
    var trackTitle = $('ol a')
      .first()
      .text()
    var buySongLink = $('ol a')
      .first()
      .data('buy-link')
    var trackPoster = $('ol a')
      .first()
      .data('poster')
  ...
  $('.sf-menu').mobileMenu({
    defaultText: '"Navigate to...", "progression"',
