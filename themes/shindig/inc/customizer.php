...
<style type="text/css">
	...
	#sidebar h5 { border-bottom:2px solid <?php echo get_theme_mod('sidebar_header_border_progression', '#292b5a'); ?>; }
	...
	.sf-menu ul { background:<?php echo get_theme_mod('pro_sub_nav_bg', '#292b5a'); ?>; }
	...
	.sf-menu li.current-menu-item a { border-top:2px solid <?php echo get_theme_mod('nav_hvr_bg', '#292b5a'); ?>; }
	...
	.sf-menu a:visited:hover, .sf-menu li.sfHover a, .sf-menu li.sfHover a:visited {
		...
		background:<?php echo get_theme_mod('nav_hvr_bg', '#292b5a'); ?>;
		border-color:<?php echo get_theme_mod('nav_hvr_bg', '#292b5a'); ?>;
	}
	...
	a.progression-button, a.more-link, body input#submit {
		background:<?php echo get_theme_mod('button_bg_progression', '#032d58;'); ?>;
	...
	a.progression-button:hover, a.more-link:hover, body input#submit:hover {
		background:<?php echo get_theme_mod('button_hover_bg_progression', '#0a3c6f;'); ?>;
	...
	.pro-button-right a {
		background:<?php echo get_theme_mod('button_bg_progression', '#032d58;'); ?>;
		border:2px solid <?php echo get_theme_mod('button_bg_progression', '#032d58;'); ?>;
		color:<?php echo get_theme_mod('button_hover_font_pro', '#ffffff'); ?>;
	}
	.pro-button-right a:hover {
		border-color:<?php echo get_theme_mod('button_hover_bg_progression', '#0a3c6f;'); ?>;
		background:<?php echo get_theme_mod('button_hover_bg_progression', '#0a3c6f;'); ?>;
		color:<?php echo get_theme_mod('button_hover_font_pro', '#ffffff'); ?>;
	}
	/* Second Button */
	...
	body #main button.button, body #main a.button, body #single-product-pro button.single_add_to_cart_button {
		...
		border:2px solid <?php echo get_theme_mod('second_border_bg_progression', '#292b5a'); ?>;
		color:<?php echo get_theme_mod('secondary_button_font_pro', '#292b5a'); ?>;
	}
	...
	body #main button.button:hover, body #main a.button:hover, body #single-product-pro button.single_add_to_cart_button:hover {
		background:<?php echo get_theme_mod('second_hover_bg_progression', '#292b5a'); ?>;
		border-color:<?php echo get_theme_mod('second_hover_bg_progression', '#292b5a'); ?>;
